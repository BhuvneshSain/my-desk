  ...
  return (
    <div className="space-y-6">
      <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-card">
        ...
        <p className="text-gray-500">Capture incoming files and attachments</p>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm text-gray-600 mb-1">From Office</label>
            ...
            filtered.slice(0,20).map((it)=>(
              <div key={it.id} className="flex items-center justify-between border rounded-md p-2">
                <div>
                  ...
                  <div className="text-gray-500">From: {it.fromOffice} • {format(new Date(it.date),'dd MMM yyyy')}</div>
                  {(it.subject || it.note) && (
